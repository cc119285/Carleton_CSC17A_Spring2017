 ...
 * Version 1.0:
 * Basic game play and instructions. Introduces 3 modes (Easy, Medium, Hard) and
 * allows the player to select one to play. Functions of the different colors 
 * has not yet been introduced, but will be added in the next version.
 */
