/* 
  ...
  Created on April 17, 2017, 11:00 AM
  Purpose: Program that allows the user to play a Random Color Puzzle game.
 * Version 1.3:
 * Added in a system to determine points; output scores and names to a 
 * binary file and read it back in at the end
 */
...
int main(int argc, char** argv) {
    ...
    do {
            ...
            switch (choice) {
                    ...
                    case '2': {player=game(binfile); numgms++;}; break;
    ...
    for (int i=1; i<=numgms; i++) {
        ...
        cout<<player.name<<"          "<<ptr->totScor<<endl;
...
UsrInfo game(fstream &binfile) {
	...
	char temp2; //Holds character's temporary location (columns)
        ...
        int score; //Stores overall score
